...
impl Sysctl for Ctl {
    ...
    #[cfg(any(target_os = "macos", target_os = "ios", target_os = "tvos", target_os = "visionos", target_os = "watchos"))]
...
mod tests {
    ...
    fn ctl_description() {
        ...
        #[cfg(any(target_os = "macos", target_os = "ios", target_os = "tvos", target_os = "visionos", target_os = "watchos", target_os = "linux"))]
        assert_eq!(descp, "[N/A]");
    }
}
